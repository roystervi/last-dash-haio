...
```bash
git remote add encore encore://zip-code-sharing-kwqi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/zip-code-sharing-kwqi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/zip-code-sharing-kwqi/settings/integrations/github)
